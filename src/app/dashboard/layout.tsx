    ...
    <div className="flex h-screen bg-slate-50 text-slate-900">
      <aside className="flex w-72 flex-col bg-slate-950 text-white">
        ...
        <nav className="flex-1 space-y-1 overflow-y-auto px-4 py-5">
          ...
          <Link href="/dashboard" className={navClass}>Dashboard</Link><Link href="/dashboard/profile" className={navClass}>My Profile</Link><Link href="/dashboard/notifications" className={navClass}>Notifications</Link>
          {canSeeTasks && <Link href="/dashboard/tasks" className={navClass}>Tasks</Link>}{canSeeProjects && <Link href="/dashboard/projects" className={navClass}>Projects</Link>}
          <Link href="/dashboard/attendance" className={navClass}>Attendance & Time</Link><Link href="/dashboard/leaves" className={navClass}>Leave Management</Link><Link href="/dashboard/calendar" className={navClass}>Company Calendar</Link><Link href="/dashboard/chat" className={navClass}>Messages</Link>
          ...
          {role === "CLIENT" && <p className="mt-6 px-4 text-xs text-slate-500">Client access is limited to the client-specific workspace.</p>}
        </nav>
