      ...
      <form action={handleSubmit} className="space-y-8">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-2">
              <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-indigo-100 font-bold text-xs text-indigo-700">1</span>
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div className="md:col-span-2"><FormField label="Street Address"><Textarea name="address" rows={2} placeholder="Full residential street address..." className="resize-none" /></FormField></div>
          </CardContent>
        </Card>
        ...
        <div className="flex items-center justify-end gap-3 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <Link href="/admin/users"><Button variant="ghost" size="md">Cancel</Button></Link>
          <Button type="submit" variant="primary" size="lg" isLoading={submitting} className="px-8 shadow-md">
