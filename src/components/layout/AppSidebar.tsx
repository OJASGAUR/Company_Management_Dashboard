    ...
    <div className="flex h-full flex-col bg-slate-950 text-slate-100">
      ...
      <div className="flex h-20 items-center justify-between border-b border-slate-900 px-6">
        <Link href="/dashboard" className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-700 font-black text-white shadow-md shadow-indigo-500/20">
            C
          </div>
          <div>
            <p className="text-sm font-extrabold tracking-tight text-white">Company OS</p>
            <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-indigo-400">Workspace</p>
          </div>
        </Link>
        {onCloseMobile && (
          <button
      ...
      <nav className="flex-1 space-y-6 overflow-y-auto px-4 py-6">
        ...
        {canManageAssets && (
          <div>
            <p className="mb-2 px-3.5 text-[11px] font-bold uppercase tracking-wider text-slate-500">Resources</p>
            <div className="space-y-1">
              <SidebarNavItem
        ...
        {canSeeFinance && (
          <div>
            <p className="mb-2 px-3.5 text-[11px] font-bold uppercase tracking-wider text-slate-500">Business</p>
            <div className="space-y-1">
              <SidebarNavItem
        ...
        {isManagement && (
          <div>
            <p className="mb-2 px-3.5 text-[11px] font-bold uppercase tracking-wider text-slate-500">Management</p>
            <div className="space-y-1">
              {canManageOperations && (
                <SidebarNavItem
      ...
      <div className="border-t border-slate-900 p-4">
        ...
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 to-indigo-800 text-sm font-bold text-white shadow-sm">
            {user.name?.charAt(0).toUpperCase() || user.email?.charAt(0).toUpperCase() || "U"}
          </div>
          <div className="min-w-0 flex-1">
            <p className="truncate text-sm font-semibold text-white">{user.name || "User Profile"}</p>
    ...
    <>
      ...
      <div className="flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white px-4 lg:hidden">
        <Link href="/dashboard" className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-slate-900">Company OS</span>
        </Link>
