...
<body style="margin:0;padding:32px 16px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;background:#f8fafc;color:#1e293b">
  <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
    <table width="100%" style="max-width:620px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;overflow:hidden" cellpadding="0" cellspacing="0">
      ...
      <tr><td style="padding:30px">
        ...
        <p style="margin:0 0 24px;line-height:1.6;color:#475569">Your company portal account has been created. Use the credentials below to sign in.</p>
        <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:12px;overflow:hidden">
          ...
          <tr><td style="padding:14px 16px;background:#f8fafc;color:#64748b;font-size:13px;font-weight:700">TEMPORARY PASSWORD</td><td style="padding:14px 16px;font-size:14px;font-family:monospace;color:#0f172a">${safePassword}</td></tr>
        </table>
        <p style="margin:20px 0 0;color:#b45309;font-size:13px;line-height:1.5"><strong>Security:</strong> Keep these credentials private and change your password after signing in.</p>
        <div style="text-align:center;margin-top:28px"><a href="${safeLoginUrl}" style="display:inline-block;background:#2563eb;color:#fff;text-decoration:none;font-weight:700;padding:12px 22px;border-radius:10px">Open Company Portal</a></div>
      </td></tr>
  ...
  if (!transporter) {
    console.log(`[EMAIL SIMULATION] To: ${toEmail} | Subject: Your Company Portal account | Employee ID: ${employeeId}`)
